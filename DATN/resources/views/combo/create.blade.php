                ...
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <select class="form-control w-75" name="" id="">
                            ...
                            <option value="1">Chọn điểm khởi hành</option>
                            <option value="1">Chọn điểm khởi hành</option>
                            <option value="1">Chọn điểm khởi hành</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control w-75" id="editor11" name=""></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="form_ext w-25">Hạng Phòng</label>
                        <textarea type="text" class="form-control w-75" id="editor" name=""></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="form_ext w-25">Hạng Phòng</label>
