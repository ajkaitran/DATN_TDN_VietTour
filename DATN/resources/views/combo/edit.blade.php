...
@section('content')
    <h2 class="title_page">Sửa Combo</h2>
    ...
    <div class="box_content">
        ...
        <div class="content px-3">
            <form action="{{ route('combo.edit', ['id' => $combos->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mx-3">
                    <div class="col-8">
                            ...
                            <select class="form-control w-75" name="start_places_id" id="">
                                ...
                                @foreach ($startPlaces as $place)
                                    <option value="{{ $place->id }}"
                                        {{ $combos->start_places_id == $place->id ? 'selected' : '' }}>{{ $place->name }}
                                    </option>
                                @endforeach
                            ...
                            <select class="form-control w-75" name="category_type_id" id="category_type_id" required>
                                ...
                                @foreach ($types as $type)
                                    <option value="{{ $type->id }}"
                                        {{ $combos->category_type_id == $type->id ? 'selected' : '' }}>{{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div class=" tbody-item-flex w-75">
                                <select class="form-control w-50" name="main_category_id" id="">
                                    ...
                                    <option value="1" {{ $combos->main_category_id == 1 ? 'selected' : '' }}>Tour
                                    </option>
                                    <option value="2" {{ $combos->main_category_id == 2 ? 'selected' : '' }}>Combor
                                    </option>
                                    <option value="3" {{ $combos->main_category_id == 3 ? 'selected' : '' }}>Visa/Hộ
                                        Chiếu</option>
                                </select>
                                <select class="form-control w-50" name="product_category_id" id="product_category_id">
                                    ...
                                    @foreach ($categories as $categorie)
                                        <option value="{{ $categorie->id }}"
                                            {{ $combos->product_category_id == $categorie->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-75">
                                ...
                                <div class="desktop-show">
                                    <img src="{{ $combos->image ? '' . Storage::url($combos->image) : '' }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control w-75" id="editor11" name="highlights">{{ $combos->highlights }}</textarea>
                        </div>
                        <div class="form-group">
                            <label class="form_ext w-25" for="">Lịch Khởi Hành</label>
                            <input type="text" class="form-control w-75" name="schedule"
                                value="{{ $combos->schedule }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control w-75" name="star" value="{{ $combos->star }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control w-75" id="editor3" name="package_price" value="">{{ $combos->package_price }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Giá Tour bao gồm</label>
                            <textarea type="text" class="form-control w-75" id="editor4" name="price_included">{{ $combos->price_included }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Giá Tour chưa bao gồm</label>
                            <textarea type="text" class="form-control w-75" id="editor5" name="price_excluded">{{ $combos->price_excluded }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Điều khoản trẻ em</label>
                            <textarea type="text" class="form-control w-75" id="editor6" name="children_policy">{{ $combos->children_policy }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Quy định đăng ký & thanh toán</label>
                            <textarea type="text" class="form-control w-75" id="editor7" name="registration_terms">{{ $combos->registration_terms }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Điều kiện hoãn hủy Tour</label>
                            <textarea type="text" class="form-control w-75" id="editor8" name="cancellation_policy">{{ $combos->cancellation_policy }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Thông tin xin Visa</label>
                            <textarea type="text" class="form-control w-75" id="editor9" name="visa_info">{{ $combos->visa_info }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Lưu ý</label>
                            <textarea type="text" class="form-control w-75" id="editor10" name="notes">{{ $combos->notes }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control w-75" cols="20" rows="4" name="title">{{ $combos->title }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="" class="form_ext w-25">Thẻ mô tả</label>
                            <textarea class="form-control w-75" cols="20" rows="4" name="detailed_description">{{ $combos->detailed_description }}</textarea>
                        </div>
