            ...
            <div className="header">
                ...
                <ul className="nav_menu">
                    <li className="nav_item">
                        <Link to='/Tour-quoc-te' className='nav_link'>TOUR QUỐC TẾ</Link>
                    </li>
                    <li className="nav_item">
                        <Link to='/Tour-quoc-te' className='nav_link'>TUOR NỘI ĐỊA</Link>
                    </li>
                    <li className="nav_item">
                        <Link to='/Tour-quoc-te' className='nav_link'>COMBO DU LỊCH</Link>
                    </li>
                    <li className="nav_item">
                        <Link to='/Tour-quoc-te' className='nav_link'>BLOG DU LỊCH</Link>
                    </li>
                    <li className="nav_item">
